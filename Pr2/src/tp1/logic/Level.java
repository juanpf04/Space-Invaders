...
public enum Level {
	...
	/**
	 * Returns Number of rows that contains Regular aliens corresponding the Level
	 * @return Number of rows that contains Regular aliens
	 */
	...
	/**
	 * Returns Number of cycles to move one cell corresponding the Level
	 * @return Number of cycles to move one cell
	 */
	...
	/**
	 * Returns Bomb frequency corresponding the Level
	 * @return Bomb Frequency
	 */
