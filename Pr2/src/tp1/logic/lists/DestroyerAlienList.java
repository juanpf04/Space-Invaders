...
public class DestroyerAlienList {
	...
	public DestroyerAlienList (Level level) {
		...
		this.size = 0;
		this.maxAliens = level.getNumDestroyerAliens();
		objects = new DestroyerAlien[this.maxAliens];
	}
	...
	/**
	 * returns the String that represents the symbol of the destroyer alien in pos.
	 * @param pos the position of the destroyer alien
	 * @return the String that represents the symbol of the destroyer alien in pos.
	 */
	...
	public void addObject(DestroyerAlien destroyerAlien) {
		
		if(!this.isFull()) {
			this.objects[this.length()] = destroyerAlien;
			this.size++;
		}
	}
